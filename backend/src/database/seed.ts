...
const SEED_INCIDENTS: Array<{
...
}> = [
  {
    ...
    description:
      'Stripe API returning 504 errors for 10% of requests. Checkout flow impacted.',
  ...
  },
  {
    ...
    description:
      'Users unable to re-authenticate after token expiry. Refresh endpoint returning 500.',
  ...
  },
  {
    ...
    description:
      'Transactional emails delayed by 15-30 minutes. SMTP provider experiencing issues.',
  ...
  },
  {
    ...
    description:
      'Some users charged twice for monthly subscription. Idempotency key issue suspected.',
    service: ServiceName.PAYMENT_API,
    severity: Severity.CRITICAL,
  ...
  },
  {
    ...
    description:
      'Legitimate users locked out after 3 attempts. Rate limit threshold misconfigured.',
    service: ServiceName.AUTH_SERVICE,
    severity: Severity.HIGH,
    status: Status.OPEN,
  },
  {
    ...
    description:
      'Firebase Cloud Messaging returning 401. API key may have been rotated.',
    service: ServiceName.NOTIFICATION_WORKER,
    severity: Severity.HIGH,
    status: Status.INVESTIGATING,
  },
  {
    ...
    description:
      'Stripe webhooks failing validation, triggering exponential retries. Queue backing up.',
    service: ServiceName.PAYMENT_API,
    severity: Severity.HIGH,
    status: Status.INVESTIGATING,
  },
  {
    ...
    description:
      'Session ID not regenerated after login. Security audit finding — needs immediate fix.',
    service: ServiceName.AUTH_SERVICE,
    severity: Severity.CRITICAL,
    status: Status.OPEN,
  },
  {
    ...
    description:
      'Twilio reporting delivery failures for T-Mobile numbers. Affecting 2FA flow.',
    service: ServiceName.NOTIFICATION_WORKER,
    severity: Severity.MEDIUM,
    status: Status.RESOLVED,
  },
  {
    ...
    description:
      'Refund jobs not being processed. Worker crashed and did not restart.',
    service: ServiceName.PAYMENT_API,
    severity: Severity.HIGH,
    status: Status.RESOLVED,
  },
  {
    ...
    description:
      'Mobile app unable to call /api/auth/* endpoints. Missing Access-Control-Allow-Origin header.',
    service: ServiceName.AUTH_SERVICE,
    severity: Severity.MEDIUM,
    status: Status.RESOLVED,
  },
  {
    ...
    description:
      'User preference changes taking 10+ minutes to propagate. Cache invalidation issue.',
    service: ServiceName.NOTIFICATION_WORKER,
  ...
  },
  {
    ...
    description:
      'Multi-currency payments showing 1-2 cent discrepancies. Floating point math issue.',
    service: ServiceName.PAYMENT_API,
    severity: Severity.MEDIUM,
    status: Status.INVESTIGATING,
  },
  {
    ...
    description:
      'Tokens issued by server A rejected by server B due to 3s clock difference.',
    service: ServiceName.AUTH_SERVICE,
    severity: Severity.LOW,
    status: Status.RESOLVED,
  },
  {
    ...
    description:
      'HTML emails showing raw Handlebars syntax. Template engine upgrade broke partials.',
    service: ServiceName.NOTIFICATION_WORKER,
    severity: Severity.MEDIUM,
    status: Status.INVESTIGATING,
  },
  {
    ...
    description:
      'Quarterly PCI DSS scan found TLS 1.0 still enabled on payment endpoints.',
    service: ServiceName.PAYMENT_API,
    severity: Severity.CRITICAL,
    status: Status.OPEN,
  },
  {
    ...
    description:
      'Users reporting expired links. Current TTL is 5 minutes — should be 30.',
    service: ServiceName.AUTH_SERVICE,
    severity: Severity.LOW,
    status: Status.OPEN,
  },
  {
    ...
    description:
      'Partner webhook payloads missing order_id field after API v2 migration.',
    service: ServiceName.NOTIFICATION_WORKER,
    severity: Severity.HIGH,
    status: Status.OPEN,
  },
